...
export default function FAQSection() {
  ...
  return (
    <motion.div ref={ref} className="flex flex-col lg:flex-row py-8 items-center gap-y-8 justify-between relative">
      <img
          src={Star}
      ...
      <motion.div className={`${isInView && window.innerWidth > 1023 && animationStart.six ? 'lg:h-[560px] xl:h-[700px]' : ''} flex flex-col gap-12`} variants={window.innerWidth >= 1024 ? leftvariants : {}} initial='hidden' animate={controls} transition={{duration: 1, ease: 'easeIn'}}>
        ...
        <div  className={`${isInView && window.innerWidth > 1023 && animationStart.six ? 'hidden' : ''}`}>
      ...
      <motion.div className="relative w-[300px] sm:w-[400px] lg:w-[700px] aspect-[5/6] lg:aspect-[10/11]" variants={window.innerWidth >= 1024 ? rightvariants : {}} initial='hidden' animate={controls}  transition={{duration: 1, ease: 'easeIn'}}>
        <img
          src={purpleStar}
