export default function Share(props) {
  return (
    <div className={`flex flex-col gap-y-2 self-center lg:self-start mt-2 mb-10 lg:my-0`}>
      <div className="text-fuchsia-500 text-base font-normal font-['Montserrat'] leading-[1.25rem]">
        Share on
      </div>
